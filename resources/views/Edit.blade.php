                    ...
                    <div class="relative flex items-start justify-between gap-4">
                        <div>
                            <div
                                ...
                                <span class="material-symbols-outlined text-[16px]"
                                    style="font-variation-settings:'FILL' 1;">auto_fix_high</span>
                                AI Photo Editor
                            </div>
                            <h1 class="font-headline-lg text-headline-md text-on-surface leading-tight">Edit Foto</h1>
                            <p class="mt-2 text-body-md text-on-surface-variant">Upload 1 foto, tulis instruksi edit, lalu
                                buat hasil visual yang clean dan profesional.</p>
                        </div>
                        ...
                        <div
                            ...
                            <span class="material-symbols-outlined"
                                style="font-variation-settings:'FILL' 1;">photo_filter</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-7">
                    ...
                    <section>
                        ...
                        <div id="uploadDropArea"
                            class="upload-zone min-h-[260px] rounded-2xl border-2 border-dashed border-outline-variant bg-surface-container-low/70 p-4 transition-all cursor-pointer overflow-hidden relative">
                            <div id="uploadEmptyTile"
                                class="absolute inset-4 rounded-2xl border border-outline-variant/50 bg-surface-container-lowest/70 flex flex-col items-center justify-center text-center p-5 hover:bg-white hover:border-primary transition-all">
                                <span
                                    class="w-16 h-16 rounded-2xl bg-primary-container text-on-primary-container flex items-center justify-center mb-4">
                                ...
                                <span class="text-label-sm text-on-surface-variant mt-1">PNG, JPG, WEBP · 1 foto
                                    utama</span>
                            </div>

                            <div id="previewFrame"
                                class="hidden absolute inset-4 rounded-2xl overflow-hidden border border-outline-variant bg-surface-container-lowest shadow-sm">
                                <img id="previewImageBlur"
                                    class="absolute inset-0 w-full h-full object-cover blur-2xl scale-110 opacity-25"
                                    alt="">
                                <img id="previewImage" class="relative z-10 w-full h-full object-contain"
                                    alt="Preview foto yang dipilih">

                                <div
                                    class="absolute left-3 right-3 bottom-3 z-20 rounded-2xl bg-white/85 backdrop-blur-xl border border-white/70 p-3 shadow-[0_12px_35px_rgba(0,0,0,0.12)]">
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="min-w-0">
                                            <p id="selectedFileName"
                                                class="truncate text-label-md font-extrabold text-on-surface">-</p>
                                            <p id="selectedFileMeta"
                                                class="mt-0.5 text-[11px] font-semibold text-on-surface-variant">Siap diedit
                                            </p>
                                        </div>

                                        <button id="removePhotoButton" type="button"
                                            class="shrink-0 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-error-container text-error hover:brightness-95 transition-all"
                                            aria-label="Hapus foto" disabled>
                        ...
                        <div class="mt-3 flex items-start gap-2">
                            <span id="uploadStatusIcon"
                                class="material-symbols-outlined text-[18px] text-on-surface-variant mt-0.5">info</span>
                            <p id="uploadMessage" class="text-label-sm text-on-surface-variant">Belum ada foto dipilih.
                                Upload foto terlebih dahulu.</p>
                        </div>

                        <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <button id="choosePhotoButton" type="button"
                                class="inline-flex items-center justify-center gap-2 rounded-2xl bg-primary text-on-primary px-5 py-3.5 font-extrabold shadow-[0_14px_30px_rgba(0,104,116,0.18)] hover:brightness-110 active:scale-[0.98] transition-all">
                                <span class="material-symbols-outlined">add_photo_alternate</span>
                                Pilih Foto
                            </button>

                            <button id="replacePhotoButton" type="button"
                                class="inline-flex items-center justify-center gap-2 rounded-2xl border border-outline-variant bg-surface-container-lowest px-5 py-3.5 font-extrabold text-on-surface hover:bg-surface-container transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                disabled>
                    ...
                    <section>
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <button id="enhancePromptButton"
                                class="text-primary flex items-center gap-1 hover:underline text-label-sm font-bold"
                                type="button">
                        ...
                        <div class="relative">
                            <textarea id="promptInput" maxlength="800"
                                ...
                                placeholder="Contoh: ubah background menjadi pantai sunset, hapus objek di belakang, pertahankan wajah asli, lighting cinematic, warna warm, hasil natural."></textarea>
                            ...
                            <div class="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-3">
                                ...
                                <span
                                    class="px-2 py-1 rounded-full bg-surface-container-lowest text-[11px] text-on-surface-variant border border-outline-variant/60">Opsional</span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div id="ratioGroup"
                            ...
                            <button type="button" data-ratio="1:1" data-label="Square"
                                class="ratio-button rounded-xl py-2.5 px-2 bg-primary-container text-on-primary-container shadow-sm font-label-md text-label-md transition-all">1:1</button>
                            <button type="button" data-ratio="16:9" data-label="Landscape"
                                class="ratio-button rounded-xl py-2.5 px-2 text-on-surface-variant hover:bg-surface-container-high font-label-md text-label-md transition-all">16:9</button>
                            <button type="button" data-ratio="9:16" data-label="Story"
                                class="ratio-button rounded-xl py-2.5 px-2 text-on-surface-variant hover:bg-surface-container-high font-label-md text-label-md transition-all">9:16</button>
                            <button type="button" data-ratio="4:5" data-label="Portrait"
                                class="ratio-button rounded-xl py-2.5 px-2 text-on-surface-variant hover:bg-surface-container-high font-label-md text-label-md transition-all">4:5</button>
                            <button type="button" data-ratio="3:2" data-label="Photo"
                                class="ratio-button rounded-xl py-2.5 px-2 text-on-surface-variant hover:bg-surface-container-high font-label-md text-label-md transition-all">3:2</button>
                        </div>
                    </section>
                    ...
                    <section>
                        <div class="flex justify-between items-center mb-3">
                            ...
                            <span class="text-label-sm text-on-surface-variant font-medium">Estimasi: <span
                                    id="creditEstimate" class="text-primary font-bold">4 Kredit</span></span>
                        </div>

                        <div id="countGroup"
                            class="grid grid-cols-4 gap-1 p-1 bg-surface-container-low rounded-2xl border border-outline-variant/50">
                            <button type="button" data-count="1"
                                class="count-button rounded-xl py-2.5 bg-primary-container text-on-primary-container shadow-sm font-label-md text-label-md transition-all">1</button>
                            <button type="button" data-count="2"
                                class="count-button rounded-xl py-2.5 text-on-surface-variant hover:bg-surface-container-high font-label-md text-label-md transition-all">2</button>
                            <button type="button" data-count="4"
                                class="count-button rounded-xl py-2.5 text-on-surface-variant hover:bg-surface-container-high font-label-md text-label-md transition-all">4</button>
                            <button type="button" data-count="8"
                                class="count-button rounded-xl py-2.5 text-on-surface-variant hover:bg-surface-container-high font-label-md text-label-md transition-all">8</button>
                        </div>
                    </section>
                    ...
                    <button id="editButton"
                        ...
                        <span id="editButtonIcon" class="material-symbols-outlined relative"
                            style="font-variation-settings:'FILL' 1;">auto_fix_high</span>
        ...
        <main class="xl:col-span-7 2xl:col-span-8 min-w-0">
            <div class="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <p id="resultSubtitle" class="text-body-md text-on-surface-variant">Hasil hanya muncul setelah proses
                        edit berhasil.</p>
                </div>

                <div class="flex flex-wrap gap-2">
                    <span id="outputRatioBadge"
                        ...
                        1:1</span>
                    <span id="outputCountBadge"
                        class="px-3 py-2 rounded-xl bg-surface-container-lowest border border-outline-variant text-label-sm font-bold text-on-surface-variant">4
                        Hasil</span>
                </div>
            </div>
            ...
            <section
                ...
                <div id="resultsEmptyState"
                    class="min-h-[510px] rounded-3xl border-2 border-dashed border-outline-variant/80 bg-gradient-to-br from-surface-container-lowest via-surface-container-low to-primary-container/10 flex flex-col items-center justify-center text-center p-8 overflow-hidden relative">
                    ...
                    <div
                        ...
                        <span id="emptyStateIcon"
                            class="material-symbols-outlined text-5xl text-primary">photo_filter</span>
                    </div>

                    <h3 id="emptyStateTitle" class="relative font-headline-md text-on-surface mb-2">Belum ada hasil edit
                    </h3>
                    <p id="emptyStateText" class="relative text-body-md text-on-surface-variant max-w-md leading-relaxed">
                        Upload foto, isi prompt edit, pilih rasio dan jumlah hasil, lalu klik tombol Edit Foto Sekarang.</p>

                    <div class="relative mt-6 flex flex-wrap justify-center gap-2">
                        <span
                            class="px-3 py-1.5 rounded-full bg-white/80 border border-outline-variant text-label-sm text-on-surface-variant">1
                            foto utama</span>
                        <span
                            class="px-3 py-1.5 rounded-full bg-white/80 border border-outline-variant text-label-sm text-on-surface-variant">Prompt
                            opsional</span>
                        <span
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function showLoadingState() {
                ...
                resultsGrid.innerHTML = '';
                resultSubtitle.textContent = 'Mengirim foto & mengantrekan ke ComfyUI...';
            ...
            function makeOverlayButton(icon, label, href = null) {
                ...
                if (href) {
                    if (label.toLowerCase().includes('download')) {
                        ...
                        element.addEventListener('click', async (event) => {
                            ...
                            try {
                                ...
                                tempLink.download = `hasil-edit-ai-${Date.now()}.jpg`;
                    ...
                    } else if (label.toLowerCase().includes('lihat')) {
                        element.href = href;
            ...
            function pollEditStatus(promptIdsParam, { maxAttempts = 150, intervalMs = 2000 } = {}) {
                return new Promise((resolve, reject) => {
                    ...
                    const timer = setInterval(async () => {
                        ...
                        try {
                            const response = await fetch(`/edit/status/${promptIdsParam}`, {
                            ...
                            if (data.status === 'error') {
                                clearInterval(timer);
                                reject(new Error(data.message || 'ComfyUI gagal merender gambar.'));
                                return;
                            }
                            ...
                            if (attempts >= maxAttempts) {
                                clearInterval(timer);
                                reject(new Error('Render timeout. Server ComfyUI mungkin sedang sibuk, coba lagi beberapa saat lagi.'));
                            }
                        } catch (err) {
                            clearInterval(timer);
                            reject(new Error('Terjadi kesalahan saat memeriksa status render dari server.'));
                        }
                    }, intervalMs);
                });
            }
            ...
            async function requestEditPhoto() {
                ...
                const queueResponse = await fetch('/edit/generate', {
                    method: 'POST',
                    headers: {
                ...
                try {
                    ...
                    throw new Error('Endpoint edit belum tersedia atau terjadi error di server.');
                }

                if (!queueData.success || !Array.isArray(queueData.prompt_ids) || queueData.prompt_ids.length === 0) {
                    throw new Error(queueData.message || 'Gagal mengantrekan proses edit ke ComfyUI.');
                }

                const promptIdsParam = queueData.prompt_ids.join(',');
                const finalImageUrls = await pollEditStatus(promptIdsParam);

                return normalizeGeneratedImages({ images: finalImageUrls });
            }
            ...
            async function handleEditPhoto() {
                if (!selectedFile) {
                    ...
                    if (input.files.length > 0) {
                        ...
                        showUploadMessage('Foto hilang, silakan pilih ulang foto.', 'error');
                        return;
                    }
                }
