...
@section('content')
                ...
                <div class="p-6 space-y-7">
                    ...
                    <section>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <!-- Product Upload -->
                            <div>
                                <input id="productInput" class="hidden" type="file"
                                    accept="image/png,image/jpeg,image/jpg,image/webp">

                                <button id="productDropzone"
                                    ...
                                    type="button" aria-label="Upload foto produk">
                                    <img id="productPreview"
                                        class="hidden absolute inset-0 w-full h-full object-contain bg-white p-3"
                                        alt="Preview produk">
                                    ...
                                    <div id="productBadge"
                                        class="hidden absolute top-3 right-3 px-3 py-1 rounded-full bg-primary text-on-primary text-[11px] font-bold items-center gap-1 shadow-lg">
                                    ...
                                    <div id="productMeta"
                                        class="hidden absolute left-3 right-3 bottom-3 rounded-xl bg-white/90 backdrop-blur-md border border-white/70 px-3 py-2 text-left shadow-lg">
                                        <p id="productFileName" class="truncate text-[11px] font-bold text-on-surface">
                                            produk.jpg</p>
                                ...
                                <button id="removeProductBtn"
                                    class="hidden mt-2 w-full py-2.5 rounded-xl border border-error text-error font-label-sm hover:bg-error-container transition-all"
                                    type="button">
                                    Hapus Produk
                                </button>
                            </div>
                            ...
                            <!-- Model Upload -->
                            <div>
                                <input id="modelInput" class="hidden" type="file"
                                    accept="image/png,image/jpeg,image/jpg,image/webp">

                                <button id="modelDropzone"
                                    class="artist-upload-zone relative group w-full aspect-[4/3] rounded-2xl border-2 border-dashed border-outline-variant bg-surface-container-low/70 hover:border-primary hover:bg-primary-container/10 transition-all cursor-pointer overflow-hidden"
                                    type="button" aria-label="Upload foto model atau artis">
                                    <img id="modelPreview"
                                        class="hidden absolute inset-0 w-full h-full object-contain bg-white p-3"
                                        alt="Preview model atau artis">
                                    ...
                                    <div id="modelMeta"
                                        class="hidden absolute left-3 right-3 bottom-3 rounded-xl bg-white/90 backdrop-blur-md border border-white/70 px-3 py-2 text-left shadow-lg">
                                        <p id="modelFileName" class="truncate text-[11px] font-bold text-on-surface">
                                            model.jpg</p>
                                        <p class="text-[10px] text-on-surface-variant">Klik untuk ganti foto</p>
                                    </div>
                                </button>
                    ...
                    <section>
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span
                                class="px-3 py-1 rounded-full bg-surface-container-low text-on-surface-variant text-label-sm font-bold">Opsional</span>
                        </div>

                        <input id="logoInput" class="hidden" type="file" accept="image/png,image/jpeg,image/jpg,image/webp">

                        <button id="logoDropzone"
                            ...
                            type="button" aria-label="Upload logo brand">
                            <div class="flex items-center gap-4 p-4 text-left">
                                <div
                                    class="relative w-20 h-20 shrink-0 rounded-2xl bg-white border border-outline-variant/60 overflow-hidden flex items-center justify-center">
                                    <img id="logoPreview" class="hidden absolute inset-0 w-full h-full object-contain p-2"
                                        alt="Preview logo">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p id="logoFileName" class="mt-1 text-label-sm text-on-surface-variant truncate">Klik
                                        atau drag logo ke area ini</p>
                    ...
                    <section>
                        ...
                        <div class="relative">
                            <textarea id="promptInput" maxlength="700"
                                ...
                                placeholder="Contoh: luxury studio campaign, soft teal lighting, produk tajam, model memegang produk secara natural, background premium, commercial photography."></textarea>

                            <div class="absolute bottom-3 left-3 right-3 flex items-center justify-between gap-3">
                                <span id="promptCounter"
                                    class="px-2 py-1 rounded-full bg-surface-container-lowest text-[11px] text-on-surface-variant border border-outline-variant/60">0/700</span>
                                <span
                    ...
                    <section>
                        ...
                        <div id="ratioGroup"
                            ...
                            <button type="button" data-ratio="16:9" data-label="Wide"
                    ...
                    <section>
                        ...
                        <div id="countGroup"
                            ...
                            <button type="button" data-count="1"
                                class="count-button rounded-xl py-2.5 bg-primary-container text-on-primary-container shadow-sm font-label-md transition-all">
                                1
                            </button>

                            <button type="button" data-count="2"
                                class="count-button rounded-xl py-2.5 text-on-surface-variant hover:bg-surface-container-high font-label-md transition-all">
                                2
                            </button>
                    ...
                    <button id="generateBtn"
                        ...
                        <span id="generateIcon" class="material-symbols-outlined relative"
                            style="font-variation-settings:'FILL' 1;">auto_awesome</span>
        ...
        <main class="xl:col-span-7 2xl:col-span-8 min-w-0">
            <div class="mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <p id="resultsSubtitle" class="text-body-md text-on-surface-variant mt-2">
                        Hasil campaign hanya muncul setelah proses generate berhasil.
                    </p>
                </div>
            ...
            <section
                ...
                <div id="emptyResults"
                    ...
                    <p id="emptyDescription" class="relative text-body-md text-on-surface-variant max-w-md leading-relaxed">
                        Upload foto produk dan model/artis, isi prompt campaign, pilih rasio dan jumlah hasil, lalu klik
                        Generate
                        Product Artist.
                    </p>
                    ...
                    <div class="relative mt-6 flex flex-wrap justify-center gap-2">
                        <span
                            class="px-3 py-1.5 rounded-full bg-white/80 border border-outline-variant text-label-sm text-on-surface-variant">Produk
                            wajib</span>
                        <span
                            class="px-3 py-1.5 rounded-full bg-white/80 border border-outline-variant text-label-sm text-on-surface-variant">Model
                            wajib</span>
                        <span
    ...
    <!-- Toast -->
    <div id="toast"
        class="hidden fixed right-6 bottom-6 z-[80] max-w-sm rounded-2xl bg-inverse-surface text-inverse-on-surface px-5 py-4 shadow-2xl">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updateOutputMeta() {
                ...
                elements.outputCountBadge.textContent = `${state.count} Hasil`;
            }
            ...
            async function pollStatus(promptId) {
                try {
                    const response = await fetch(`/artist/status/${promptId}`);
                    ...
                    if (data.status === 'processing') {
                        // LOOPING: Jika masih proses, tunggu 3 detik lalu panggil fungsi ini lagi
                        setTimeout(() => pollStatus(promptId), 3000);
                    } else if (data.status === 'success') {
                        // SELESAI: Render hasilnya dan buka kembali form
                    ...
                    showEmptyState('Gagal Memuat Hasil', error.message, 'warning');
            ...
            async function handleGenerate() {
                ...
                elements.generateText.textContent = 'Mengirim ke AI...';
                showLoadingState();

                try {
                    // 1. Upload file dan dapatkan Prompt ID
                    const data = await requestGenerate();

                    if (data.prompt_id) {
                        elements.generateText.textContent = 'AI Sedang Memproses...';
                        showToast('Antrean AI berhasil dimulai. Harap tunggu...', 'info');

                        // 2. Mulai proses loop (polling) mengecek status
                        pollStatus(data.prompt_id);
                    } else {
                        throw new Error("Gagal mendapatkan ID antrean dari server.");
                    }
                } catch (error) {
            ...
            setButtonActive(elements.countButtons, document.querySelector('.count-button[data-count="1"]'));
            updateOutputMeta();
            refreshFormState();
